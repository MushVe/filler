...
/*   Updated: 2019/11/21 03:29:42 by cseguier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_gnl	*add_node(t_gnl *elem, int fd)
{
	t_gnl	*control;
...
int		god_like(char *buf, t_gnl *control, char **line, int way)
{
	char	*tmp;
	char	*tmp2;
...
int		read_mem(int fd, char *buf, t_gnl *control, char **line)
{
	int	ret;
